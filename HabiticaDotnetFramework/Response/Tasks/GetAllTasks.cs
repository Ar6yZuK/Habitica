...
public class GetAllTasks
{
	...
	public class TaskData
	{
		...
		[JsonConverter(typeof(DateTimeOffsetToLocalJsonConverter))]
	...
	{
		public class DateTimeOffsetUnixMillisecondConverter : JsonConverter<DateTimeOffset>
		{
	...
	public class DateTimeOffsetToLocalJsonConverter : JsonConverter<DateTimeOffset>
	{
		public override DateTimeOffset Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
